// scribe.js
// Injected into web pages to record user interactions

(function() {
    if (window.hasScribeInjected) {
        return; // Already injected
    }
    window.hasScribeInjected = true;

    console.log('Scribe.js injected. Recording user actions...');
